...
class ReadComicOnline {
    ...
    async getChapterDetails(mangaId, chapterId) {
        ...
        return await (0, ReadComicOnlineParser_1.parseChapterDetails)(response.data, rguardUrl, mangaId, chapterId, this);
    }
    async getSearchTags() {
        const request = App.createRequest({
...
},{"./ReadComicOnlineParser":71,"@paperback/types":61}],71:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.isLastPage = exports.parseSearch = exports.parseTags = exports.parseViewMore = exports.parseHomeSections = exports.parseChapterDetails = exports.urlDecode = exports.trimIndent = exports.parseChapters = exports.parseMangaDetails = void 0;
...
const parseMangaDetails = ($, mangaId) => {
    ...
    const titles = [(0, entities_1.decodeHTML)($('a.bigChar').text().trim())];
    ...
    const description = (0, entities_1.decodeHTML)($('span:contains(Summary)', contentSection).parent().next().text().trim() ?? '');
    let hentai = false;
    const arrayTags = [];
...
const parseChapters = ($) => {
    ...
    for (const chapter of $('tr', $('.listing').first()).toArray()) {
        ...
        chapters.push(App.createChapter({
            id: chapterId,
            name: (0, entities_1.decodeHTML)(title),
            langCode: '🇬🇧',
...
const DISABLE_JS_SCRIPT = (0, exports.trimIndent)(`
    const handler = {
...
`);
const ATOB_SCRIPT = (0, exports.trimIndent)(`
...
`);
const urlDecode = (urls, rguardScript) => {
...
const parseChapterDetails = async (data, rguardUrl, mangaId, chapterId, source) => {
    ...
    const decodedUrls = (0, exports.urlDecode)(urls, response?.data);
...
const parseHomeSections = ($, sectionCallback) => {
    ...
    for (const comic of $('a', $('div.items', 'div.bigBarContainer')).toArray()) {
        ...
        if (image == '')
            image = $('img', comic).first().attr('srctemp') ?? '';
        image = image.startsWith('/') ? RCO_DOMAIN + image : image;
