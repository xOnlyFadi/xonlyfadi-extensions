...
class TuMangaOnline extends types_1.Source {
    constructor() {
        super(...arguments);
...
},{"./TuMangaOnlineParser":60,"./TuMangaOnlineSettings":61,"@paperback/types":58}],60:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
                    ...
                    rows: async () => [
                        App.createDUISwitch({
                            ...
                            value: App.createDUIBinding({
                                get: () => (0, exports.getNSFW)(stateManager),
                                set: (newValue) => stateManager.store('nsfw', newValue)
                            }),
                        })
                    ]
                })
