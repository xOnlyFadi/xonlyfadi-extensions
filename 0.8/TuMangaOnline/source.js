...
},{"./TuMangaOnlineParser":71,"./TuMangaOnlineSettings":72,"@paperback/types":61}],71:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Parser {
    ...
    parseHomeSection($, baseUrl) {
        ...
        for (const obj of $('div.element').toArray()) {
            ...
            const title = (0, entities_1.decodeHTML)($('h4.text-truncate', info).text().trim()) ?? (0, entities_1.decodeHTML)($('h4.text-truncate', info)?.attr('title')?.trim() ?? '') ?? '';
    ...
    parseMangaDetails($, mangaId) {
        ...
        const title2 = (0, entities_1.decodeHTML)($('h2.element-subtitle').first().text().trim()) ?? '';
        const image = $('.book-thumbnail').attr('src') ?? 'https://paperback.moe/icons/logo-alt.svg';
        const desc = (0, entities_1.decodeHTML)($('p.element-description').text().trim()) ?? '';
        const infoAuth = $('h5.card-title');
        const author = (0, entities_1.decodeHTML)(infoAuth.first().text().trim().substringAfterFirst(', ')) ?? '';
        const artist = (0, entities_1.decodeHTML)(infoAuth.last().text().trim().substringAfterFirst(', ')) ?? '';
        const status = (0, entities_1.decodeHTML)($('span.book-status').text().trim()) ?? '';
        const arrayTags = [];
...
},{"../scopes":73,"entities":69}],72:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
