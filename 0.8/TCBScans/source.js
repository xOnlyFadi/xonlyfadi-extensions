...
var _Sources = (() => {
  ...
  var Parser = class {
    ...
    async parseHomeSections($, sectionCallback) {
  ...
  var TCBScansInfo = {
    ...
    language: "ENGLISH",
    intents: import_types.SourceIntents.HOMEPAGE_SECTIONS | import_types.SourceIntents.MANGA_CHAPTERS | import_types.SourceIntents.CLOUDFLARE_BYPASS_REQUIRED
  };
  var TCBScans = class {
    constructor(cheerio) {
      this.cheerio = cheerio;
