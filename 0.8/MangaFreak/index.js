...
class MangaFreak {
    ...
    CloudFlareError(status) {
        if (status == 503 || status == 403) {
            throw new Error(`CLOUDFLARE BYPASS ERROR:\nPlease go to Settings > Sources > ${exports.MangaFreakInfo.name} and press Cloudflare Bypass`);
        }
    }
}
exports.MangaFreak = MangaFreak;

},{"./MangaFreakParser":71,"@paperback/types":61}],71:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Parser {
    ...
    async parseHomeSections($, sectionCallback, cdnUrl) {
        ...
        for (const obj of $('.featured_item_info', $('.box .featured_list div')).toArray()) {
            ...
            Popular.push(App.createPartialSourceManga({
                ...
                title: (0, entities_1.decodeHTML)(title),
                mangaId: id,
                subtitle: (0, entities_1.decodeHTML)(subtitle)
            }));
        }
    ...
    parseMangaDetails($, mangaId, cdnUrl) {
        ...
        return App.createSourceManga({
            ...
            mangaInfo: App.createMangaInfo({
                ...
                artist: (0, entities_1.decodeHTML)(artist),
    ...
    getImageSrc(imageObj) {
        ...
        return encodeURI(decodeURI((0, entities_1.decodeHTML)(image?.trim() ?? '')));
    }
    parseStatus(str) {
        let status = 'ONGOING';
