...
var _Sources = (() => {
  ...
  var Parser = class {
    ...
    async parseHomeSections($, sectionCallback, cdnUrl) {
      const top5Section = App.createHomeSection({ id: "top5", title: "Top 5", containsMoreItems: false, type: import_types.HomeSectionType.featured });
      const popularSection = App.createHomeSection({ id: "popular", title: "Popular", containsMoreItems: true, type: import_types.HomeSectionType.singleRowNormal });
      const TodayMangaSection = App.createHomeSection({ id: "today_manga", title: "Today's Manga", containsMoreItems: true, type: import_types.HomeSectionType.singleRowNormal });
      const YesterdayMangaSection = App.createHomeSection({ id: "yesterday_manga", title: "Yesterday's Manga", containsMoreItems: false, type: import_types.HomeSectionType.singleRowNormal });
      const OlderMangaSection = App.createHomeSection({ id: "older_manga", title: "Older Manga", containsMoreItems: false, type: import_types.HomeSectionType.singleRowNormal });
      const Top5 = [];
      const Popular = [];
      const TodayManga = [];
    ...
    ViewMoreParse($, cdnUrl, isPopular) {
      const results = [];
    ...
    parseSearchResults($, cdnUrl, UsesDeatils) {
      const results = [];
  ...
  var MangaFreak_CDN = "https://images.mangafreak.net";
  var MangaFreakInfo = {
    author: "xOnlyFadi",
    ...
    intents: import_types2.SourceIntents.CLOUDFLARE_BYPASS_REQUIRED | import_types2.SourceIntents.HOMEPAGE_SECTIONS | import_types2.SourceIntents.MANGA_CHAPTERS,
    language: "English",
    sourceTags: [
      {
        text: "Cloudflare",
  ...
  var MangaFreak = class {
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
      ...
      metadata = this.parser.NextPage($) ? { page: page + 1 } : void 0;
