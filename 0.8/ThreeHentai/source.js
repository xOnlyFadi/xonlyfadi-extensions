...
exports.ThreeHentaiInfo = {
    ...
    language: 'Multiple',
    intents: types_1.SourceIntents.HOMEPAGE_SECTIONS | types_1.SourceIntents.SETTINGS_UI,
    sourceTags: [
        {
            text: 'Multi Language',
...
class ThreeHentai extends types_1.Source {
    constructor() {
        super(...arguments);
    ...
    async getHomePageSections(sectionCallback) {
        const section1 = App.createHomeSection({ id: 'date', title: 'Recent', containsMoreItems: true, type: types_1.HomeSectionType.singleRowNormal });
        const section2 = App.createHomeSection({ id: 'popular-24h', title: 'Popular Today', containsMoreItems: true, type: types_1.HomeSectionType.singleRowNormal });
        const section3 = App.createHomeSection({ id: 'popular-7d', title: 'Popular Week', containsMoreItems: true, type: types_1.HomeSectionType.singleRowNormal });
        const section4 = App.createHomeSection({ id: 'popular', title: 'Popular All-time', containsMoreItems: true, type: types_1.HomeSectionType.singleRowNormal });
...
},{"./ThreeHentaiHelper":63,"./ThreeHentaiParser":64,"./ThreeHentaiSettings":65,"@paperback/types":58}],63:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class THLanguagesClass {
    ...
    getPBCode(THCode) {
        return this.Languages.filter(Language => Language.THCode == THCode)[0]?.PBCode ?? 'UNKNOWN';
    }
    getDefault() {
    ...
    parseSearchResults($, _source) {
        ...
        for (const obj of $('#main-content .listing-container .doujin-col').toArray()) {
            ...
            results.push(App.createPartialSourceManga({
                ...
                subtitle: ThreeHentaiHelper_1.THLanguages.getName(this.LanguageFlag($('.title', obj))),
            }));
        }
        return results;
    }
    ...
    parseSearchResultsArchive($, _source, detailsid) {
        ...
        if (id || title) {
            results.push(App.createPartialSourceManga({
                ...
                image,
                title: this.decodeHTMLEntity(title),
                subtitle: ThreeHentaiHelper_1.THLanguages.getName(subtitle ?? ''),
            }));
        }
        return results;
    }
...
},{"./ThreeHentaiHelper":63,"buffer":60}],65:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
                ...
                App.createDUISection({
                    ...
                    rows: async () => [
                        App.createDUISelect({
                            ...
                            labelResolver: async (option) => ThreeHentaiHelper_1.THLanguages.getName(option),
                        ...
                        App.createDUISelect({
                            ...
                            labelResolver: async (option) => ThreeHentaiHelper_1.THSortOrders.getName(option),
                            value: App.createDUIBinding({
                                get: () => (0, exports.getSortOrders)(stateManager),
                                set: (newValue) => stateManager.store('sort_order', newValue)
                            }),
                            allowsMultiselect: false,
                        }),
                        App.createDUIInputField({
                            ...
                            value: App.createDUIBinding({
                                ...
                                set: (newValue) => stateManager.store('extra_args', newValue)
                            }),
                        })
                    ]
                })
