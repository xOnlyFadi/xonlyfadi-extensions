...
},{"./MangaSectParser":71,"@paperback/types":61}],71:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const parseMangaDetails = ($, mangaId) => {
    const title = (0, entities_1.decodeHTML)($('header h1').text().trim());
    ...
    const description = (0, entities_1.decodeHTML)($('article #syn-target').text().trim() ?? '');
