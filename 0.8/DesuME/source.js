...
class DesuME {
    ...
    async getChapters(mangaId) {
        ...
        return (0, DesuMEParser_1.parseChapters)(data);
    }
    ...
    CloudFlareError(status) {
        if (status == 503 || status == 403) {
            throw new Error(`CLOUDFLARE BYPASS ERROR:\nPlease go to Settings > Sources > ${exports.DesuMEInfo.name} and press Cloudflare Bypass`);
        }
    }
}
exports.DesuME = DesuME;

},{"../scopes":72,"./DesuMEParser":71,"@paperback/types":61}],71:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../scopes":72,"entities":69}],72:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
