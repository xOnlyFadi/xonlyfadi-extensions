...
const VoyceME_Base = 'https://voyce.me';
exports.VoyceMEInfo = {
    author: 'xOnlyFadi',
...
class VoyceME extends types_1.Source {
    constructor() {
        super(...arguments);
    ...
    async getChapterDetails(mangaId, chapterId) {
        ...
        const dataResponse = await this.ChapterDetailsApiRequest(buildId, mangaId, chapterId);
        return this.parser.parseChapterDetails(dataResponse, mangaId, chapterId, this);
    }
    async ChapterDetailsApiRequest(buildId, mangaId, chapterI) {
        const chapterId = chapterI.substringAfterLast('/').substringBeforeFirst('#');
        const options = App.createRequest({
            url: `${VoyceME_Base}/_next/data/${buildId}/series/${mangaId}/${chapterId}.json`,
            method: 'GET'
        });
        const response = await this.requestManager.schedule(options, 1);
...
},{"./VoyceMEGraphQL":113,"./VoyceMEParser":114,"@paperback/types":58}],113:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Parser {
    ...
    parseChapterDetails(dataResponse, mangaId, chapterId, source) {
        const pages = [];
...
},{"entities":71,"html-to-text":73}]},{},[112])(112)
});
