...
},{"./ComickParser":104,"./ComickSettings":105,"paperback-extensions-common":56}],103:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./ComickHelper":103,"entities":14,"html-to-text":16,"paperback-extensions-common":56}],105:[function(require,module,exports){
"use strict";
/* eslint-disable @typescript-eslint/no-explicit-any */
Object.defineProperty(exports, "__esModule", { value: true });
            ...
            sections: () => {
                return Promise.resolve([
                    createSection({
                        ...
                        rows: () => {
                            return Promise.all([
                                (0, exports.getShowChapterVolume)(stateManager),
                                (0, exports.getShowChapterTitle)(stateManager)
                            ]).then(async (values) => {
                                return [
                                    createSwitch({
                    ...
                    createSection({
                        ...
                        rows: () => {
                            return Promise.all([
                                ...
                                (0, exports.getHomeFilter)(stateManager),
                            ]).then(async (values) => {
                                return [
                                    createSelect({
                                        id: 'languages',
                                        ...
                                        displayLabel: option => ComickHelper_1.CMLanguages.getName(option),
                                        value: values[0],
