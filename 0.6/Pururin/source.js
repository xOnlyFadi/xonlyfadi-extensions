...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Pururin = exports.PururinInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const PururinParser_1 = require("./PururinParser");
require("../scopes");
...
let slug;
class Pururin extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
    ...
    getMangaShareUrl(mangaId) { return `${DOMAIN}/gallery/${mangaId}/${slug}`; }
    async getHomePageSections(sectionCallback) {
        ...
        for (const section of sections) {
            ...
            const request = createRequestObject({
                url: SEARCH_URL,
                method: 'POST',
                data: (0, PururinParser_1.parseMetadata)(Calls, { page: 1 })
            });
            promises.push(this.requestManager.schedule(request, 1).then(response => {
                this.CloudFlareError(response.status);
                let data;
                try {
                    const FirstData = JSON.parse(response.data);
                    try {
                ...
                section.items = (0, PururinParser_1.parseSearch)(data);
                sectionCallback(section);
            }));
        }
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
        ...
        const request = createRequestObject({
            url: SEARCH_URL,
            method: 'POST',
            data: (0, PururinParser_1.parseMetadata)(Calls, metadata)
        });
        ...
        const manga = (0, PururinParser_1.parseSearch)(data);
    ...
    async getSearchResults(query, metadata) {
        ...
        const request = createRequestObject({
            url: SEARCH_URL,
            method: 'POST',
            data: (0, PururinParser_1.parseMetadata)(query, metadata)
        });
        const response = await this.requestManager.schedule(request, 1);
        this.CloudFlareError(response.status);
        let data;
    ...
    async getMangaDetails(mangaId) {
        ...
        return (0, PururinParser_1.parseMangaDetails)(data, mangaId);
    }
    async getChapters(mangaId) {
        ...
        return (0, PururinParser_1.parseChapters)(data, mangaId);
    }
    async getChapterDetails(mangaId, chapterId) {
        ...
        return (0, PururinParser_1.parseChapterDetails)(data, mangaId, chapterId);
    }
    async getTags() {
        return (0, PururinParser_1.parseTags)();
    }
    async getSearchFields() {
        return (0, PururinParser_1.parseSearchFields)();
    }
...
exports.Pururin = Pururin;

},{"../scopes":58,"./PururinParser":57,"paperback-extensions-common":13}],57:[function(require,module,exports){
"use strict";
/* eslint-disable @typescript-eslint/ban-ts-comment */
/* eslint-disable @typescript-eslint/no-explicit-any */
/* eslint-disable @typescript-eslint/explicit-module-boundary-types */
Object.defineProperty(exports, "__esModule", { value: true });
exports.parseSearchFields = exports.parseTags = exports.parseMetadata = exports.parseChapterDetails = exports.parseChapters = exports.parseMangaDetails = exports.parseSearch = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
...
const parseMangaDetails = (data, mangaId) => {
    ...
    if (details?.j_title)
        titles.push(details?.j_title.trim());
    if (details?.alt_title)
        titles.push(details?.alt_title.trim());
    if (details?.full_title)
        titles.push(details?.full_title.trim());
...
const parseMetadata = (query, metadata) => {
    ...
    if (MaxRange > 1000)
        throw new Error('\'Maximum\' cannot exceed greater than 1000');
    const data = {
        'search': {
            'PageNumber': page,
            'manga': {
...
},{"../scopes":58,"entities":9,"paperback-extensions-common":13}],58:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
