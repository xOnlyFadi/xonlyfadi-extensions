...
const ThreeHentaiSettings_1 = require("./ThreeHentaiSettings");
const ThreeHentaiParser_1 = require("./ThreeHentaiParser");
const ThreeHentai_Base = 'https://3hentai.net';
exports.ThreeHentaiInfo = {
    author: 'xOnlyFadi',
...
class ThreeHentai extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
        this.parser = new ThreeHentaiParser_1.Parser();
...
},{"./ThreeHentaiHelper":52,"./ThreeHentaiParser":53,"./ThreeHentaiSettings":54,"paperback-extensions-common":8}],52:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.THSortOrders = exports.THLanguages = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
    ...
    constructor() {
        this.Languages = [
            ...
            },
            {
                ...
                name: 'Español',
                THCode: 'spanish',
                PBCode: paperback_extensions_common_1.LanguageCode.SPANISH
            },
            {
                // French
                name: 'Français',
                THCode: 'french',
                PBCode: paperback_extensions_common_1.LanguageCode.FRENCH
            },
            {
                // Portuguese
                name: 'Português',
                THCode: 'portuguese',
                PBCode: paperback_extensions_common_1.LanguageCode.PORTUGUESE
            },
            {
                // Russian
                name: 'Русский',
                THCode: 'russian',
                PBCode: paperback_extensions_common_1.LanguageCode.RUSSIAN
            },
            {
                // German
                name: 'Deutsch',
                THCode: 'german',
                PBCode: paperback_extensions_common_1.LanguageCode.GERMAN
            },
        ];
...
exports.THLanguages = new THLanguagesClass();
...
exports.THSortOrders = new THSortOrderClass();

},{"paperback-extensions-common":8}],53:[function(require,module,exports){
(function (Buffer){(function (){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
            ...
            if (id || title) {
                results.push(createMangaTile({
                    ...
                    subtitleText: createIconText({
                        text: ThreeHentaiHelper_1.THLanguages.getName(this.LanguageFlag($('.title', obj)))
                    }),
                }));
            }
        }
        ...
        form: createForm({
            ...
            sections: () => {
                return Promise.resolve([
                    createSection({
                        id: 'content',
                        footer: 'Modify the 3hentai experience to your liking.',
                        rows: () => {
                            return Promise.all([
